...
var _SearchSelectBox = __webpack_require__(28);

var _SearchSelectBox2 = _interopRequireDefault(_SearchSelectBox);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_SearchSelectBox2.default, null), document.getElementById('container'));
...
*/
var aa=__webpack_require__(2),ba=__webpack_require__(1),m=__webpack_require__(11),p=__webpack_require__(4),v=__webpack_require__(3),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(14),ha=__webpack_require__(5);
...
var _last2 = __webpack_require__(29);
...
var _SearchOptionsMenu = __webpack_require__(33);

var _SearchOptionsMenu2 = _interopRequireDefault(_SearchOptionsMenu);

var _mockServerApi = __webpack_require__(48);

var _mockServerApi2 = _interopRequireDefault(_mockServerApi);

var _searchSelectBoxHelper = __webpack_require__(49);
...
var EMPTY_ARRAY = [],
  ...
  searchResults: EMPTY_ARRAY
    ...
    INITIAL_STATE = _extends({}, INIT_SEARCH_RESULTS, {
...
var SearchSelectBox = function (_PureComponent) {
  _inherits(SearchSelectBox, _PureComponent);
  ...
  function SearchSelectBox() {
    ...
    _classCallCheck(this, SearchSelectBox);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchSelectBox.__proto__ || Object.getPrototypeOf(SearchSelectBox)).call.apply(_ref, [this].concat(args))), _this), _this.state = INITIAL_STATE, _this.handleSearch = function (searchQuery) {
      _this.setState({
        ...
        focusedOptionIndex: 0,
        loading: true
      }, _this.fetchSearchSuggestions);
    }, _this.handBlur = function () {
      _this.setState(_extends({}, INIT_SEARCH_RESULTS, {
        selectedOptions: EMPTY_ARRAY
      }));
    }, _this.handleClearText = function () {
      _this.setState(INITIAL_STATE);
    }, _this.handleRequestError = function () {
      _this.setState({
        loading: false,
        errorMessage: 'Sorry, error while fetching suggestions'
      });
    }, _this.getCurrentSearchQuery = function () {
      var _this2 = _this,
          _this2$state = _this2.state,
          selectedOptions = _this2$state.selectedOptions,
          searchQuery = _this2$state.searchQuery;

      return selectedOptions.length ? (0, _searchSelectBoxHelper.getLastWord)(searchQuery) : searchQuery.trim();
    }, _this.fetchSearchSuggestions = function () {
      var targetQuery = _this.getCurrentSearchQuery();
      if (targetQuery) {
        (0, _mockServerApi2.default)(targetQuery).then(function (response) {
          _this.setState({
            errorMessage: undefined,
    ...
    }, _this.handleFocusSearchOption = function (newFocusedOptionIndex) {
      _this.setState({
        focusedOptionIndex: +newFocusedOptionIndex
      });
    }, _this.handleSelectSearchOption = function () {
      ...
      var newQuery = searchResults[focusedOptionIndex];

      _this.setState(_extends({
        searchQuery: (0, _searchSelectBoxHelper.getNewSearchQuery)(newQuery, selectedOptions), // if any previous selected options exists
        ...
        case KEY_CODES.ENTER:
          {
            if (_this.state.isOpen) {
              _this.handleSelectSearchOption();
            }
            break;
          }
        case KEY_CODES.ARROW_UP:
          {
            ...
            var updatedFocusedOptionIndex = focusedOptionIndex === 0 ? lastSearchMenuOptionIndex : focusedOptionIndex - 1; // to maintain cyclic navigation
            _this.handleFocusSearchOption(updatedFocusedOptionIndex);
            break;
          }
        case KEY_CODES.ARROW_DOWN:
          {
            var _updatedFocusedOptionIndex = focusedOptionIndex === lastSearchMenuOptionIndex ? 0 : focusedOptionIndex + 1; // to maintain cyclic navigation
            _this.handleFocusSearchOption(_updatedFocusedOptionIndex);
            break;
          }
        case KEY_CODES.BACKSPACE:
          {
            if (event.target.tagName === 'INPUT' && selectedOptions.length) {
              // when we start pressing back space we check with last previously selectedOptions
              var lastWord = (0, _searchSelectBoxHelper.getLastWord)(searchQuery);
              var lastSelectedOption = (0, _last3.default)(selectedOptions);
  ...
  _createClass(SearchSelectBox, [{
    key: 'renderSearchResults',
    value: function renderSearchResults() {
      var state = this.state;


      return state.isOpen && !state.loading && _react2.default.createElement(_SearchOptionsMenu2.default, {
...
var SEARCH_ICONS_URL = 'https://www.shareicon.net/download/2015/10/03/110917_search.ico';
  ...
  _createClass(SearchInput, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('img', { className: 'searchIcon', src: SEARCH_ICONS_URL }),
...
SearchInput.propTypes = {
  ...
  clearText: _propTypes2.default.func,
...
var _MenuOption = __webpack_require__(34);

var _MenuOption2 = _interopRequireDefault(_MenuOption);

var _escapeRegExp2 = __webpack_require__(35);
...
var EMPTY_MESSAGE = 'No suggestions found';
...
function getHighlightedSearchResult(string, subString, className) {
  var regExp = new RegExp((0, _escapeRegExp3.default)(subString), 'ig'),
      // to escape special characters
  result = regExp.exec(string);

  if (result) {
    var startingIndex = result.index,
        // starting index of result in the string
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'span',
        { className: className },
        string.substring(startingIndex, endIndex)
      ),
...
var SearchOptionsMenu = function (_React$Component) {
  _inherits(SearchOptionsMenu, _React$Component);
  ...
  function SearchOptionsMenu() {
    ...
    _classCallCheck(this, SearchOptionsMenu);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchOptionsMenu.__proto__ || Object.getPrototypeOf(SearchOptionsMenu)).call.apply(_ref, [this].concat(args))), _this), _this.renderOption = function (option, index) {
      return _react2.default.createElement(
        _MenuOption2.default,
        _extends({}, _this.props, {
          optionIndex: index,
          key: index
        }),
        getHighlightedSearchResult(option, _this.props.searchQuery, 'matchText')
      );
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(SearchOptionsMenu, [{
    key: 'render',
    value: function render() {
      ...
      if (errorMessage || !menuOptions.length) {
        var text = errorMessage || EMPTY_MESSAGE;
        return _react2.default.createElement(
          'div',
...
var MenuOption = function (_React$Component) {
  ...
  function MenuOption() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MenuOption.__proto__ || Object.getPrototypeOf(MenuOption)).call.apply(_ref, [this].concat(args))), _this), _this.handleFocusOption = function (event) {
 ...
 */
var getLastWord = exports.getLastWord = function getLastWord(searchQuery) {
  var wordsArray = searchQuery.split(' ');
 ...
 */
var getNewSearchQuery = exports.getNewSearchQuery = function getNewSearchQuery(newQuery, selectedOptions) {
  var selectedSuggestions = selectedOptions.join(' ');
